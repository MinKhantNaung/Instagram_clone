<div class="max-w-lg mx-auto">
            ...
            <div x-init="new Swiper($el, {
                ...
                <div x-cloak class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img src="https://images.pexels.com/photos/99551/hot-air-balloon-valley-sky-99551.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    ...
    <footer>
        ...
        <div class="flex text-sm gap-2 font-medium">
            <p><strong>{{ fake()->name }}</strong>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam reprehenderit possimus quia id ab
                aspernatur accusantium quaerat sapiente doloribus exercitationem rem soluta quidem rerum quos, eveniet
                veniam, at architecto cum?
            </p>
        </div>
